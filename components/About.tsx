    ...
    >
      ...
      <div className="flex flex-col lgl:flex-row gap-16">
        <div className="w-full lgl:w-2/3 text-base text-textDark font-medium flex flex-col gap-4">
          <p>
            Hello! My name is Jaun Raza and I enjoy creating things that
        ...
        <div className="w-full lgl:w-1/3 h-80 relative group">
          <div className="absolute w-full h-80 -left-6 -top-6 rounded-lg ">
            <div className="w-full h-full relative z-20 flex pl-6 lgl:pl-0">
              <img className="rounded-lg h-full object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtJlE5wp2x3SsSJSZIJGxOJ7exk98kZBCjbg&s" alt="" />
